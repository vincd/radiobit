...
QDEF(MP_QSTR_esb_send_keys, (const byte*)"\x29\x0d" "esb_send_keys")
QDEF(MP_QSTR_esb_send_bytes, (const byte*)"\x34\x0e" "esb_send_bytes")
QDEF(MP_QSTR_esb_send_set_keep_alive, (const byte*)"\x63\x17" "esb_send_set_keep_alive")
QDEF(MP_QSTR_esb_send_keep_alive, (const byte*)"\xfe\x13" "esb_send_keep_alive")
